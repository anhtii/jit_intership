set_property SRC_FILE_INFO {cfile:E:/NOIDUNGCHUANBI/UART/UART.srcs/constrs_1/new/nexys.xdc rfile:../../../UART.srcs/constrs_1/new/nexys.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { heartbeat }];
set_property src_info {type:XDC file:1 line:79 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports reset_n]
set_property src_info {type:XDC file:1 line:80 export:INPUT save:INPUT read:READ} [current_design]
set_property PULLUP TRUE [get_ports reset_n]#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { BTNU }]; #IO_L4N_T0_D05_14 Sch=btnu
